...
class DemoApplicationLike(application: Application,
                          tinkerFlags: Int,
    ...
    application, tinkerFlags, tinkerLoadVerifyFlag, applicationStartElapsedTime, applicationStartMillisTime, tinkerResultIntent
) {
    override fun onCreate() {
         ...
         * 参数3：是否开启debug
         */
        //Bugly.init(applicationContext, Constant.BuglyId, false)
        ...
        Bugly.init(application, Constant.BuglyId, true)
    }
